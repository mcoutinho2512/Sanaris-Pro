...
import { Calendar, Clock, User, Filter, Plus, CheckCircle, XCircle, Play, Check } from 'lucide-react';
      ...
      <div className="bg-white p-4 rounded-lg shadow mb-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div className="flex items-end">
            <button
              onClick={loadData}
              className="w-full bg-gray-100 px-4 py-2 rounded-lg hover:bg-gray-200 transition flex items-center justify-center gap-2"
            >
              <Filter size={20} />
              Filtrar
            </button>
                    ...
                    {appointment.status === 'scheduled' && (
                      <>
                        <button
                          ...
                          className="px-3 py-2 bg-green-100 text-green-700 rounded-lg hover:bg-green-200 transition flex items-center gap-2"
                          title="Confirmar"
                        >
                          <CheckCircle size={16} />
                          Confirmar
